...
Este es un script en Python diseñado para automatizar la búsqueda de ofertas de empleo (enfocadas en Ciberseguridad) desde la plataforma [Get On Board](https://www.getonbrd.com/).
